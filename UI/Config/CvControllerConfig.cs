			...
			switch(type) {
				case ControllerType.ColecoVisionController:
					Dictionary<KeyPresetType, string[]> presets = new() {
						{ KeyPresetType.ArrowKeys, ["Up Arrow", "Down Arrow", "Left Arrow", "Right Arrow",
							"A", "S",
							"Numpad 1", "Numpad 2", "Numpad 3", "Numpad 4", "Numpad 5", "Numpad 6", "Numpad 7", "Numpad 8", "Numpad 9", "Numpad 0",
							"Q", "W"
						] },
						{ KeyPresetType.WasdKeys, ["W", "D", "A", "S",
							"Q", "E",
							"Numpad 1", "Numpad 2", "Numpad 3", "Numpad 4", "Numpad 5", "Numpad 6", "Numpad 7", "Numpad 8", "Numpad 9", "Numpad 0",
							"R", "F"
						] },
						{ KeyPresetType.XboxP1, ["Pad1 Up", "Pad1 Down", "Pad1 Left", "Pad1 Right",
							"Pad1 X", "Pad1 A",
						...
						{ KeyPresetType.XboxP2, ["Pad1 Up", "Pad2 Down", "Pad2 Left", "Pad2 Right",
							"Pad2 X", "Pad2 A",
						...
						{ KeyPresetType.Ps4P1, ["Joy1 DPad Up", "Joy1 DPad Down", "Joy1 DPad Left", "Joy1 DPad Right",
							"Joy1 But1", "Joy1 But2",
						...
						{ KeyPresetType.Ps4P2, ["Joy2 DPad Up", "Joy2 DPad Down", "Joy2 DPad Left", "Joy2 DPad Right",
							"Joy2 But1", "Joy2 But2",
